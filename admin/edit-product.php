                            ...
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea rows="3" required name="price" value="<?= $data['price'];?>" placeholder="Enter price" class="form-control mb-2"></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="number" required name="quantity"  placeholder="Enter quantity" value="<?= $data['qty'];?>" class="form-control mb-2">
                                        </div>
                                        <div class="col-md-6">
